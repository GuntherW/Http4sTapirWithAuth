...
object Library {
  ...
  val catsEffect        = "org.typelevel"                %% "cats-effect-std"          % Version.catsEffect
  ...
  val tapirSwagger      = "com.softwaremill.sttp.tapir"  %% "tapir-swagger-ui"         % Version.tapirVersion
  val tapirRedoc        = "com.softwaremill.sttp.tapir"  %% "tapir-redoc"              % Version.tapirVersion
